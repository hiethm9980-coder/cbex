...
class AppColors {
  ...
  // ── Primary Navy (CBEX brand) ──
  static const Color primaryDeep   = Color(0xFF141A2E);
  static const Color primary       = Color(0xFF1E253E); // CBEX primary
  static const Color primaryMid    = Color(0xFF283254);
  static const Color primaryLight  = Color(0xFF3A4D6E);
  static const Color primarySoft   = Color(0xFFEEF1F6);
  static const Color primaryBorder = Color(0xFFD6DDEB);
  static const Color primaryGhost  = Color(0xFFF4F6FA);

  // ── Secondary (CBEX brand red — used for primary CTAs/buttons) ──
  static const Color secondary     = Color(0xFFD04A4B); // CBEX secondary
  static const Color secondaryDark = Color(0xFFB23E3F);
  static const Color secondarySoft = Color(0xFFFDEFF0);
